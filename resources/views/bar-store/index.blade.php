...
<nav class="page-breadcrumb" style="display:flex; justify-content: space-between">
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="{{route('bar.store.index')}}">Bar Store Items</a></li>
      <li class="breadcrumb-item active" aria-current="page">List</li>
    </ol>
    <div>
        <a class="btn btn-primary" href="{{route('bar.store.recipe')}}">Add Item</a>
        <a class="btn btn-primary" href="{{route('bar.store.adjust')}}">Adjust Stock</a>
...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
            <h6 class="card-title">Bar Store Items Table</h6>
