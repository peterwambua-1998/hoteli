    ...
    <div class="col-md-12 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
            {{-- invoice details --}}
            <div class="mb-2">
                <h4 class="mb-4">Purchase Order Details</h4>
                <div style="display: flex; justify-content:space-between">
                    
                    <p class="mb-3" style="color: #808080">PO No: <span id="inv_no">{{rand(0, 1000000)}}</span></p>
                </div>
                <div class="row">
                    <div class="mb-3 col-md-6">
                        <label for="exampleInputUsername1" class="form-label">Date Issued</label>
