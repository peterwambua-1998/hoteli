...
<nav class="page-breadcrumb" style="display:flex; justify-content: space-around">
    ...
    <div>
        <a class="btn btn-primary" style="width: 100%;" href="{{route('main.store.adjust')}}"><ion-icon style="position: relative; top:3px; right: 5px; color: #fff; font-size: 16px;" name="add-circle-outline"></ion-icon> Adjust Stock</a>
    </div>
</nav>
...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
            <h6 class="card-title">Main Store Items Table</h6>
