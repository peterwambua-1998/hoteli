                            ...
                            <div class="invoice-head-middle">
                                ...
                                <div class="invoice-head-bottom">
                                    ...
                                    <div class="invoice-head-left">
                                        <ul>
                                            <li class="text-bold">Credited To:</li>
                                    ...
                                    <div class="invoice-head-right">
                                        <table>
                                            <tr>
                                                <td>Tax Date</td>
                                                <td>{{$creditNote->tax_date}}</td>
                                            </tr>
                                            <tr>
                                                <td>Invoice No</td>
                                                <td>{{$creditNote->note_number}}</td>
                                            </tr>
                                            <tr>
                                                <td>Delivery Date</td>
                                                <td>{{$creditNote->delivery_date}}</td>
                                            </tr>
                                            <tr>
                                    ...
                                    <table>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="bordered text-end">{{number_format($creditNote->sub_total, 2)}}</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="bordered text-end">{{number_format($creditNote->tax_amount, 2)}}</td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="bordered text-end">{{number_format($creditNote->total, 2)}}</td>
