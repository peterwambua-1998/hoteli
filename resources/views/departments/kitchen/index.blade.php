...
<nav class="page-breadcrumb" style="display:flex; justify-content: space-between">
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="{{route('kitchen.requisition.view')}}">Material Requisition</a></li>
      <li class="breadcrumb-item active" aria-current="page">List</li>
    </ol>
    <div>
        <a href="{{route('kitchen.requisition.create')}}" class="btn btn-primary">Request Item</a>
    </div>
</nav>
...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
            <h6 class="card-title">Kitchen Material Requisition Table</h6>
