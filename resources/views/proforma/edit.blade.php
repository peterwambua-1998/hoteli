...
<nav class="page-breadcrumb" style="display:flex; justify-content: space-between">
    <ol class="breadcrumb" style="width: 85%">
      <li class="breadcrumb-item"><a href="{{route('accounts.index')}}">Proforma Invoice</a></li>
      <li class="breadcrumb-item active" aria-current="page">List</li>
    </ol>
    <a href="{{route('proforma.show', $invoice->id)}}"><button class="btn btn-warning">Back</button></a>
</nav>
...
<form action="{{route('proforma.update', $invoice->id)}}" method="post">
@csrf
@method('PATCH')
    ...
    <div class="col-md-12 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
            {{-- invoice details --}}
            <div class="mb-2">
                <h4 class="mb-4">Proforma Invoice Details</h4>
