        ...
        <div class="card-body">
            ...
            <div class="mb-2">
                ...
                <div style="display: flex; justify-content:space-between">
                    ...
                    <p class="mb-3" style="color: #808080">Inv No: <span id="inv_no">{{rand(0, 1000000)}}</span></p>
                </div>
                <div class="row">
                    <div class="mb-3 col-md-3">
                        <label for="exampleInputUsername1" class="form-label">Delivery Date</label>
                        <input required type="date" class="form-control" name="delivery_date" id="exampleInputUsername1" autocomplete="off">
                    </div>

                    <div class="mb-3 col-md-3">
                        <label for="exampleInputUsername1" class="form-label">Tax Date</label>
                        <input required type="date" name="tax_date" class="form-control" id="exampleInputUsername1" autocomplete="off" >
                    </div>
