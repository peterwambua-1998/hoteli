...
<nav class="page-breadcrumb" style="display:flex; justify-content: space-between">
    <ol class="breadcrumb" style="width: 85%">
      <li class="breadcrumb-item"><a href="{{route('accounts.index')}}">Stock Adjustment</a></li>
...
<form action="{{route('kitchen.store.adjust.store')}}" method="post">
@csrf
    ...
    <div class="col-md-12 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
            {{-- invoice details --}}
            <div class="mb-2">
                <h4 class="mb-4">Kitchen Store Stock Adjustment</h4>
            ...
            <div>
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered" id="dataTableExample">
                        ...
                        <tbody id="table-row">
                            @foreach ($kitchenStoreItems as $key => $item)
                            <?php
