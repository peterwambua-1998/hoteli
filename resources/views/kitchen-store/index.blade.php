...
<nav class="page-breadcrumb" style="display:flex; justify-content: space-between">
    <ol class="breadcrumb" style="">
      <li class="breadcrumb-item"><a href="{{route('kitchen.store.index')}}">Kitchen Store Items</a></li>
      <li class="breadcrumb-item active" aria-current="page">List</li>
    </ol>
    <div>
        <a class="btn btn-primary"  href="{{route('kitchen.store.recipe')}}"> Add Item</a>
        <a class="btn btn-primary"  href="{{route('kitchen.store.adjust')}}"> Adjust Stock</a>
    </div>
</nav>
...
<div class="row">
    <div class="col-md-12 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
            <h6 class="card-title">Kitchen Store Items Table</h6>
