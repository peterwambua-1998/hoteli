...
class PosBarController extends Controller
{
    ...
    public function posPage()
    {
        ...
        return view('departments.bar.pos', compact('items', 'customers'));
    }
    ...
    public function orders()
    {
        ...
        return view('departments.bar.orders', compact('orders', 'bankAccounts'));
    }
    ...
    public function ordersPrint($id)
    {
        ...
        return view('departments.bar.print', compact('order', 'order_details'));
    }
    ...
    public function addToExistingOrderPage($id)
    {
        ...
        if ($order) {
            return view('departments.bar.posAddOrder', compact('order', 'items'));
        } 
        return redirect()->back()->with('error', 'System error, please try again.');
    }
        ...
        try {
            ...
            if ($invoice) {
                for ($i=0; $i < count($request->item_id); $i++) { 
                    ...
                    $p->amount = $request->quantity[$i] * $product->price;
