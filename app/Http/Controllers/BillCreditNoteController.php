...
class BillCreditNoteController extends Controller
{
    /**
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $creditNoteItem = new BillCreditNoteItem();
            $creditNoteItem->bill_id = $request->bill_id;
            $creditNoteItem->bill_credit_note_id = $creditNote->id;
     ...
     */
    public function show(BillCreditNote $billCreditNote)
    {
        //
    }
     ...
     */
    public function edit(BillCreditNote $billCreditNote)
    {
        //
    }
     ...
     */
    public function update(Request $request, BillCreditNote $billCreditNote)
    {
        //
    }
     ...
     */
    public function destroy(BillCreditNote $billCreditNote)
    {
        //
    }
}
